...
status = platform.update_hw(hw_design = "$COMPONENT_LOCATION/../../workspace_vivado/basys3_exam/soc_stop_watch_wrapper.xsa")
...
platform = client.create_platform_component(name = "platform_watch",hw_design = "$COMPONENT_LOCATION/../../workspace_vivado/basys3_exam/soc_watch_wrapper.xsa",os = "standalone",cpu = "microblaze_riscv_0",domain_name = "standalone_microblaze_riscv_0")

comp = client.create_app_component(name="app_watch",platform = "$COMPONENT_LOCATION/../platform_watch/export/platform_watch/platform_watch.xpfm",domain = "standalone_microblaze_riscv_0",template = "hello_world")
...
client.delete_component(name="app_watch")

client.delete_component(name="platform_watch")
